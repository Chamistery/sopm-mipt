...
/** Назначить или сменить тимлида. Можно вызывать сколько угодно раз.
 *  Бэкенд проверяет: вызывающий — ментор этого проекта или координатор,
 *  и что новый лидер — участник команды (запись в team_members). */
