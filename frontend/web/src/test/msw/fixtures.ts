...
export const fixtureProjects = [
  ...
  },
  {
    ...
    company: 'Т-Банк',
    courses: [2, 3],
    description: 'Кросс-платформенное приложение с push-уведомлениями о расписании занятий.',
    technologies: ['React Native', 'TypeScript', 'Go'],
    teamSizeMin: 3,
    teamSizeMax: 5,
    numTeams: 1,
    filledTeams: 0,
  ...
  {
    id: 104,
    title: 'Сервис распределения ВШПИ',
    status: 'Опубликован' as const,
    mentorId: MENTOR_ID,
    company: 'ВШПИ МФТИ',
    courses: [2],
    description: 'Алгоритм распределения студентов по проектам с учётом приоритетов и совместимости.',
  ...
  {
    id: 105,
    title: 'CRM для студенческих стартапов',
    status: 'Опубликован' as const,
    mentorId: MENTOR_ID,
    company: 'Бизнес-инкубатор МФТИ',
    courses: [2, 3, 4],
    description: 'CRM-система для управления портфелем стартапов студентов МФТИ.',
    technologies: ['Vue', 'NestJS', 'PostgreSQL'],
    teamSizeMin: 3,
    teamSizeMax: 6,
    numTeams: 1,
    filledTeams: 0,
